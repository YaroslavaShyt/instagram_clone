...
import 'package:instagram_clone_ys/user_page/contacts.dart';
...
class UserPage extends StatefulWidget {
  ...
  const UserPage({Key? key, this.collection = 'accounts', required this.detailsPath}) : super(key: key);
      ...
      itemBuilder: (context, index) => Column(
        children: [
          Row1(
            ...
            subscribers:
                snapshot.data!.docs[index].data()['subscribers'].toString(),
            subscriptions:
                snapshot.data!.docs[index].data()['subscriptions'].toString(),
          ),
          Row2(
            nameSurname: snapshot.data!.docs[index].data()['name'] +
                ' ' +
          ...
          Row(children: const [
            ContactCard(
                accountPhoto:
                    'https://firebasestorage.googleapis.com/v0/b/flutterinstagramys.appspot.com/o/20210722_133655.jpg?alt=media&token=da9d86f2-ecae-40c3-af50-810fa6a2c749',
